...
import { editNoEmailUserSchema } from '../../../validations/editNoEmailUserSchema'
import { EHeading } from '../../01_elements/EHeading/base'
import { TErrorTemplate } from '../../03_templates/TErrorTemplate'
import { TLoadingTemplate } from '../../03_templates/TLoadingTemplate'
import { TUserRegisterFormNoEmailTemplate } from '../../03_templates/TUserRegisterFormTemplate/no-email'
import { Seo } from '../../99_seo/users/Seo'

const schema = z.object(editNoEmailUserSchema)
...
const Component: FC = () => {
  ...
  return (
    <>
      ...
      <TUserRegisterFormNoEmailTemplate
...
export { Component as SUserRegistrationNoEmailScreen }
